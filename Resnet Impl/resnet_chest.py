...
Original file is located at
    https://colab.research.google.com/drive/1T0aNwliTBcshhtFr48PqoZ4cliO6pzfR
...
nonTB_path = '/home/taherizade/Sajid Ali Final Project/Project Codes/MainCode MEdi Image Analysis/imgs/health'
...
# y_train and y_test contain class lables 0 and 1 representing Tuberculosis and NonTB for X_train and X_test
...
for index, probability in enumerate(prediction):
  if probability[1] > 0.5:
        plt.title('%.2f' % (probability[1]*100) + '% Tubercilosis')
  else:
